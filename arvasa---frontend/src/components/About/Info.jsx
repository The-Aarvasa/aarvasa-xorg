...
const Info = ({scrollToContact}) => {
    return (
        <div className="relative h-auto px-2 overflow-hidden md:px-8 md:mx-8 font-[poppins]">
            {/* Heading */}
            <div className="mb-8">
                <div className="text-3xl font-[Poppins] font-medium pt-6 pb-4 text-black dark:text-white">
                    Who We Are
            ...
            <div className="flex relative flex-col md:px-8 lg:flex-row items-center justify-center gap-8 ">
                ...
                <div className="w-full md:w-auto p-4 bg-gradient-to-l from-pink-900 to-pink-800 rounded-md md:rounded-[20px] h-full md:rounded-[32px] md:p-6 lg:p-12 dark:bg-gradient-to-r from-[#CBAD4B] to-[#722F36]">
                    <p className="text-white text-xl leading-relaxed dark:text-black">
            ...
            {/* Quote */}
            <div className="text-center text-pink-900 text-xl md:text-3xl mt-8 mb-8 font-bold font-['Poppins'] leading-13 md:m-12 dark:text-white">
            ...
            <div className="flex h-auto xl:h-[80vh] flex-wrap lg:flex-nowrap gap-4 lg:gap-[1.875rem] items-stretch mx-2 lg:mx-8">
                ...
                <div className="flex flex-col gap-4 w-full lg:w-1/2 h-full">
                    <div className="bg-pink-800 p-6 rounded-2xl flex flex-col gap-4 h-full dark:bg-gradient-to-b from-[#8A2740] to-[#2C0C14]">
                ...
                <motion.div
                    ...
                    className="flex flex-col justify-around p-6 gap-8 md:gap-1 bg-pink-800 rounded-2xl w-full lg:w-1/2 h-full dark:bg-gradient-to-b from-[#D8AE24] to-[#504219]"
                >
                    <div className="flex flex-col justify-start items-start gap-4">
                        <span className="text-white text-3xl font-extrabold leading-normal dark:text-black">Aarvasa</span>
                        <span className="text-white text-md tracking-wide font-medium font-['Poppins'] leading-normal dark:text-black">
