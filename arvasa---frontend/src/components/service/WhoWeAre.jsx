    ...
    <section className="font-[poppins] px-8 md:px-24 py-10 pt-16 flex flex-col lg:flex-row items-center justify-between">
      ...
      <div className="lg:w-1/2 w-full mb-10 lg:mb-0">
        ...
        <div className="flex gap-4">
          <button className="bg-gradient-to-r from-yellow-400 to-orange-400 text-black font-semibold text-sm md:text-md px-6 py-2 rounded-md hover:scale-105 hover:shadow-lg transition duration-300">
            Contact Us
          </button>
          <button className="border-2 border-[#6C1E3C] text-[#6C1E3C] font-semibold px-6 py-2 text-sm md:text-md rounded-md hover:bg-[#6C1E3C] hover:text-white transition duration-300">
            View Services
          </button>
        </div>
      </div>
