...
const InsideArticle = () => {
    return (
        <div className="inside-article-container max-w-screen-2xl mx-auto px-4 py-6">
            <div className="bg-white rounded-lg overflow-hidden">
                ...
                <img
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwz_Ord72siqLlZVcJSiQWKAp_sflvuSgj4g&s"
                    alt="Building"
                    className="w-full h-auto rounded-3xl mb-8 shadow-md hover:shadow-2xl hover:scale-[1.02] transition duration-300"
                />
                ...
                <div className="px-4 py-4">
                    ...
                    <div className='mx-auto max-w-7xl'>
                        <div className="flex flex-col sm:flex-row text-base sm:text-2xl justify-between items-center mb-10">
                            <p>April 8, 2025 | Real Estate Today</p>
                            <p className='text-gray-600'>California, USA</p>
                        </div>

                        <h2 className="text-xl sm:text-3xl mb-10">What's happening in the suburban real estate market right now?</h2>
                        <p className="mb-10 text-base sm:text-2xl">
                        ...
                        <h2 className="text-xl sm:text-3xl mb-10">Why are more people moving to the suburbs?</h2>
                        <p className="mb-10 text-base sm:text-2xl">
                        ...
                        <h2 className="text-xl sm:text-3xl mb-10">Which regions are seeing the biggest growth?</h2>
                        <p className="mb-10 text-base sm:text-2xl">
                        ...
                        <h2 className="text-xl sm:text-3xl mb-10">Are housing prices going up or down?</h2>
                        <p className="mb-10 text-base sm:text-2xl">
