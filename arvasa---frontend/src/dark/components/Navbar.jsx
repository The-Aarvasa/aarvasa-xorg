                ...
                <div className="lg:mx-8 flex items-center justify-between mx-auto">
                    ...
                    <ul
                        ...
                        className={`
                            ...
                            transition-all bg-black lg:bg-transparent h-[100vh] w-[80%] pt-[150px] px-12
                    ...
                    >
                        {data.map((item, i) => (
                            <li className="relative group w-fit" key={i}>
                                <Link to={`/${item.path}`}>
                                    <p className="text-md text-white lg:text-lg font-[500] group-hover:text-[#D4AF37]">
                                        {item.route}
                                    </p>
                                </Link>
                                <span className="absolute w-0 h-1 left-0 bottom-[-5px] rounded-full bg-[#D4AF37] group-hover:w-full group-hover:opacity-75 transition-all duration-700"></span>
