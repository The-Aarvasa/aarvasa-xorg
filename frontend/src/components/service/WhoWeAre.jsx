  ...
  return (
    <section className="font-[poppins] px-8 md:px-24 flex flex-col lg:flex-row flex-wrap items-center justify-center md:justify-between">
      ...
      <div className="lg:w-1/2  mb-10 lg:mb-0">
        ...
        <div className="inline-block bg-[#FEEEB3] px-4 py-2 rounded-md text-sm font-semibold mb-4 animate-bounce duration-700 dark:bg-[#BC9A2A] text-black">
          Built Dream And Securing Future
        </div>

        <h2 className="text-2xl md:text-5xl font-bold text-[#6C1E3C] leading-snug mb-4 dark:text-white">
          All-inclusive Real Estate <br /> Solutions for Buyers & <br></br> Investors
        </h2>

        <p className="text-sm text-[#6C1E3C] max-w-md mb-6 dark:text-white">
        ...
        <div className="flex gap-4">
          ...
          <button onClick={scrollService} className="border-2 border-[#6C1E3C] text-[#6C1E3C] font-semibold px-6 py-2 text-sm md:text-md rounded-md hover:bg-[#6C1E3C] hover:text-white transition duration-300 dark:border-white">
            View Services
          </button>
        </div>
      </div>
